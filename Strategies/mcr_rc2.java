...
public class mcr_rc2 implements IStrategy {
    ...
    @Configurable("MA Applied Price")
    public AppliedPrice maAppliedPrice = AppliedPrice.CLOSE;
    @Configurable("MA Time Period")
    public int maPeriod = 34;
    @Configurable("MA Type")
    public MaType maType = MaType.EMA;
    @Configurable("RSI Applied Price")
    public AppliedPrice rsiAppliedPrice = AppliedPrice.CLOSE;
    ...
    public void onStart(IContext context) throws JFException {
        ...
        if (chart != null && engine.getType() == IEngine.Type.TEST) {
            chart.addIndicator(indicators.getIndicator("CCI"), new Object[] {cciPeriod});
    ...
    public void onBar(Instrument instrument, Period period, IBar askBar, IBar bidBar) throws JFException {
        ...
        double cci = indicators.cci(instrument, period, OfferSide.BID, cciPeriod, 0);
        double ma = indicators.ma(instrument, period, OfferSide.BID, maAppliedPrice, maPeriod, maType, 0);
